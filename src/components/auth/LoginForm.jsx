...
import { getGitHubLoginUrl } from "../../services/Auth/authService.js";
    ...
    return (
        <div className="w-full max-w-md space-y-8">
            ...
            <form onSubmit={onSubmit} className="space-y-6">
                ...
                className="w-full h-12 bg-gray-900 hover:bg-gray-800 text-white rounded-md flex items-center justify-center transition-transform transform hover:scale-105"
                disabled={isLoading}
            >
